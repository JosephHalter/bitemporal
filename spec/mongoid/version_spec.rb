...
describe Bitemporal::Mongoid::Version do
  ...
  describe "#at?(time)" do
    subject { BitemporalSpec::Mongoid::Version.new :valid_from => valid_from, :valid_to => valid_to, :created_at => created_at, :expired_at => expired_at }
